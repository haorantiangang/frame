...
//		shape = a.getInt(R.styleable.slideswitch_shape_sw, SHAPE_RECT);
//		leftText = a.getString(R.styleable.slideswitch_lefttext);
//		rightText = a.getString(R.styleable.slideswitch_righttext);
//		a.recycle();
//	}
//
...
//		  width = measureDimension(280, widthMeasureSpec);
//		  height = measureDimension(140, heightMeasureSpec);
...
//		      canvas.drawText(rightText,width*4/7,height*3/5,paint);
//		      paint.setColor(Color.WHITE);
//		      paint.setTextSize(32);
//		      canvas.drawText(leftText,width/10,height*3/5,paint);
//	}
//
//	@Override
